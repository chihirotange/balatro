...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnCardDiscarded, ACard*, Card, bool, IsLastCard);
...
public:
	...
	virtual void DiscardCardEvent(ACard* DiscardedCard, bool IsLastCard) override;
